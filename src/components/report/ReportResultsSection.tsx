                ...
                <div key={profName} data-pdf-section="profile" className="print:break-inside-avoid">
                  ...
                  {shouldShowProfile(nonSubheaderParams) && (
                    <>
                      ...
                      <div className="<div className="px-3 py-1 font-semibold bg-blue-50 print:bg-transparent border-2 border-gray-600" style={{ color: '#2E3192', fontSize: profileFontSize }}>
                        {profName}
