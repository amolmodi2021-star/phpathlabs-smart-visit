  ...
  const handlePrint = () => {
    ...
    pages.forEach((pageTests, pageIdx) => {
      ...
      if (isLast) {
        ...
        summaryHtml += `<td style="width:38%;vertical-align:top;padding-right:12px;border:0">${leftHtml}</td>`;
        summaryHtml += `<td style="width:62%;vertical-align:top;padding-left:2px;border:0">`;
            ...
            <div style={{ display: "flex", gap: 6, alignItems: "flex-start", justifyContent: "flex-start" }}>
              ...
              <div style={{ flex: "1 1 0", minWidth: 0 }}>
                ...
                {Number(data.paid_amount || 0) > 0 && (
                  <div style={{ fontSize: 11, marginTop: 8, color: PALETTE.muted, lineHeight: 1.45, textAlign: "left" }}>
