-- One-off production data fix; only apply if that registration exists locally.
DO $$
BEGIN
  IF EXISTS (
    SELECT 1 FROM public.patient_registrations
    WHERE id = '68d6ebdc-0986-4230-bdeb-ca422765c8e6'
  ) THEN
